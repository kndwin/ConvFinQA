...
export const datasetChatSessionSelectionMachine = setup({
  types: {
  ...
  id: "datasetChatSessionSelection",
...
export const datasetChatTranscriptMachine = setup({
  types: {
