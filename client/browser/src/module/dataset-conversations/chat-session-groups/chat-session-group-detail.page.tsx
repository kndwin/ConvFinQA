...
} from "../chat/dataset-chat.ui";
import type { AgentApproach } from "../chat/dataset-chat.query";
import { datasetChatMessagesOptions, type PersistedMessage } from "../chat/dataset-chat.query";
...
function GroupSessionCard({
  ...
  datasetId: number;
  session: { id: number; agent_approach: AgentApproach; model: string };
    ...
    <article className="flex h-[32rem] min-h-0 min-w-0 flex-col rounded-lg border p-4">
      ...
      {messages.isError ? (
        ...
        <ChatTranscript
          ...
          agentApproach={session.agent_approach}
